...
* Align the seat catch hook boss [5] with the seat rail hole [6].
...
Disconnect the seat lock cable [1] from the seat lock cylinder [2].  
Remove the lock spring [3], seat lock cylinder, and stay [4].  
Installation is in the reverse order of removal.

**NOTE:**
* Align the seat lock cylinder lug [5] with the left fender B cover groove [6] and stay groove [7].
